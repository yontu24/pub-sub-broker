...
public class SubscriptionGeneratorSetup {
	...
	public SubscriptionGeneratorSetup(Properties properties) {
		...
		companyEqualFields = calculateNumberOfFields(Double.parseDouble(properties.getProperty("companyEqualWeight")),
				companyFields);
		valueEqualFields = calculateNumberOfFields(Double.parseDouble(properties.getProperty("valueEqualWeight")),
				valueFields);
		dropEqualFields = calculateNumberOfFields(Double.parseDouble(properties.getProperty("dropEqualWeight")),
				dropFields);
		variationEqualFields = calculateNumberOfFields(
				Double.parseDouble(properties.getProperty("variationEqualWeight")), variationFields);
		dateEqualFields = calculateNumberOfFields(Double.parseDouble(properties.getProperty("dateEqualWeight")),
				dateFields);
	}
